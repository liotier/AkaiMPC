# Akai MPC Chord Progression Generator - Preview Version

**⚠️ This is a preview version with new features under development**
...
**[Access the preview MPC Chord Progression Generator](https://liotier.github.io/AkaiMPC/AkaiMPCChordProgressionGeneratorPreview/AkaiMPCChordProgressionGenerator.html)**

**[Access the stable production version](https://liotier.github.io/AkaiMPC/AkaiMPCChordProgressionGenerator/AkaiMPCChordProgressionGenerator.html)**

This preview version includes experimental features and improvements that are being tested before merging into the main release.
...
- Enhanced random generation buttons with better UX
- Refactored codebase split into separate HTML, CSS, and JavaScript files
- Additional context modes under development (Guitar, Keyboard)
...
---------------------------------
This preview version uses a modular architecture split into three static files for better maintainability:
...
**GitHub: [Source Code](https://github.com/liotier/AkaiMPC/tree/main/AkaiMPCChordProgressionGeneratorPreview)**
